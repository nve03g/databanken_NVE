...
CREATE TABLE IF NOT EXISTS "Event_X_Category" (
	"eventCategoryID"	INTEGER NOT NULL UNIQUE,
	"eventID"	INTEGER NOT NULL,
	"categoryID"	INTEGER NOT NULL,
	FOREIGN KEY("eventID") REFERENCES "Event"("eventID"),
	FOREIGN KEY("categoryID") REFERENCES "Category"("categoryID"),
	PRIMARY KEY("eventCategoryID" AUTOINCREMENT)
);
...
INSERT INTO Event VALUES(1,'Rock Werchter 2024','2024/07/04-2024/07/07','12:00',1,1,'https://www.rockwerchter.be/en/',0,'Avril Lavigne, The Beaches, Benjamin Clementine, The Breeders, ...');
INSERT INTO Event VALUES(2,'Nieuwpoort Beach Festival 2025','2025/07/18-2025/07/20','12:00',2,1,'https://www.beachfestival.be',1,'Who Knows');
INSERT INTO Event VALUES(3,'Tomorrowland 2024','2024/07/19-2024/07/28','12:00',3,2,'https://www.tomorrowland.com/home/',0,'DJ Mars, Bosart, Dietro, ...');

INSERT INTO Event_X_Category VALUES(1,1,1);      -- Rock Werchter - Rock
INSERT INTO Event_X_Category VALUES(2,2,1);      -- Beach Fest - Rock
INSERT INTO Event_X_Category VALUES(3,2,2);      -- Beach Fest - Pop
INSERT INTO Event_X_Category VALUES(4,3,3);      -- Tomorrowland - Dance
